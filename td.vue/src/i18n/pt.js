const por = {
    ...
    threatmodel: {
        ...
        ai: {
            analyzing: 'Analisando componente selecionado...',
            configureProvider: 'Configure o Provedor de IA e a Chave da API para começar.',
            configureButton: 'Configurar Provedor de IA',
            noThreats: 'Nenhuma ameaça identificada para este componente. Tente selecionar outro componente.',
            applyThreat: 'Aplicar esta Ameaça',
            applyAllThreats: 'Aplicar Todas as Ameaças',
            appliedSuccess: 'Ameaça "{title}" aplicada com sucesso!',
            appliedAllSuccess: '{count} ameaças aplicadas com sucesso!',
            sessionKeyWarning: 'A chave da API será armazenada apenas durante a sessão atual',
            error: 'Erro durante a análise. Verifique o console para detalhes.'
        },
        diagram: {
            diagrams: 'Diagramas',
